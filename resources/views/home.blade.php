...
<section class="home-strip">
    @foreach($categories as $category)
        <a class="home-mini" href="{{ route('catalog.category', $category) }}" data-category="{{ $category->name }}">
            @if($category->image)
    ...
    <section class="collection-section">
        <div class="collection-banner">
            <div class="banner-content">
                ...
                <a href="{{ route('catalog.index') }}" class="btn">Смотреть коллекцию</a>
            </div>
        </div>
        ...
        <div class="collection-grid-layout">
            <div class="collection-side-banner">
                <div class="side-banner-content">
                    ...
                    <a href="{{ route('catalog.index') }}" class="btn">Смотреть</a>
                </div>
            </div>
