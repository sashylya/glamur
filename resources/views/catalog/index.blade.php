        ...
        <div class="catalog-search-bar" style="margin-bottom: 30px;">
            <form method="GET" action="{{ route('catalog.index') }}" style="display: flex; gap: 10px;">
                ...
                <input type="text" 
                       ...
                       style="flex: 1; padding: 12px 20px; border: 1px solid #000; border-radius: 4px; font-size: 16px;">
                <button type="submit" class="btn" style="padding: 0 30px;">Найти</button>
            </form>
        </div>

        <div class="catalog-header">
            <h1>{{ $title ?? 'Каталог украшений' }}</h1>
